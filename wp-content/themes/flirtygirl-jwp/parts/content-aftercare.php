...
$aftercare_title = get_field( 'aftercare_title', 'option' );
$aftercare_headline = get_field( 'aftercare_headline', 'option' );
?>
	...
	<div class="custom-content grid-container">
		<div class="inner-content grid-x grid-margin-x grid-padding-x">
			<div class="small-12 medium-12 cell">
				<?php echo do_shortcode('[flourish title="'.$aftercare_title.'" color="black" type="h2" alt="false"]'); ?>
				<h3 class="text-center"><?php echo $aftercare_headline; ?></h3>
				<div id="aftercare-carousel" class="owl-carousel">
				<?php

...
$output .= '    .wpsl-search {text-align:center;}' . "\r\n";
$output .= '    #wpsl-search-input {width:250px;}' . "\r\n"; 
$output .= '    #wpsl-search-btn {padding:unset; line-height:unset; font-weight:unset; color:unset; background-color:unset; background-repeat:unset; background-image:unset; box-shadow:unset; text-transform:unset;}' . "\r\n"; 
$output .= '    #wpsl-search-btn, #wpsl-search-wrap input {border: 3px solid rgb(236, 0, 140); border-radius: 15px; padding:.25rem 1.5rem; font-size:14px; font-weight:bold; text-transform:uppercase !important; line-height:1.2;}' . "\r\n";
$output .= '    #wpsl-search-btn:hover { color: #fff; background-color: rgb(236, 0, 140); }' . "\r\n"; 
$output .= '    .wpsl-store-location p strong a:hover {color: rgb(236, 0, 140);}' . "\r\n"; 
$output .= '</style>' . "\r\n";
...
//$output .= '<h1>Book Now!</h1>' . "\r\n";
//$output .= '<h3>Enter your zipcode and we\'ll locate a Flirty Girl Location near you.</h3>' . "\r\n";
...
//$output .= "\t\t\t\t" . '<div class="wpsl-icon-direction"><span>&#xe800;</span></div>';
$output .= "\t\t\t" . '</div>' . "\r\n";
...
$output .= "\t\t\t\t" . '<div class="wpsl-search-btn-wrap"><input class="cta-button" id="wpsl-search-btn" type="submit" value="' . esc_attr( $wpsl->i18n->get_translation( 'search_btn_label', __( 'Search', 'wpsl' ) ) ) . '"></div>' . "\r\n";
...
$output .= "\t\t\t" . '<ul class="grid-x grid-padding-x align-stretch xxmedium-up-3"></ul>' . "\r\n";
$output .= "\t\t" . '</div>' . "\r\n";
